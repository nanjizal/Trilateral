...
var fracs_DifferencePreference = { __ename__ : true, __constructs__ : ["CLOCKWISE","ANTICLOCKWISE","SMALL","LARGE"] };
...
var testTrilateral_TestCanvas = function() {
	this.upDown = false;
	this.downDown = false;
...
testTrilateral_TestCanvas.__name__ = true;
testTrilateral_TestCanvas.main = function() {
	new testTrilateral_TestCanvas();
};
testTrilateral_TestCanvas.prototype = {
	...
	,render: function(i) {
		...
		while(_g1 < _g) {
			...
			g.drawTri([tri.ax * 1.,tri.ay * 1.,tri.bx * 1.,tri.by * 1.,tri.cx * 1.,tri.cy * 1.]);
			g.endFill();
		}
	}
	,keyDown: function(e) {
...
testTrilateral_TestCanvas.main();
})();
